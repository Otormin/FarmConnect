                                ...
                                if ($getJobDetailsResult && mysqli_num_rows($getJobDetailsResult) > 0) {
                                    while ($row = mysqli_fetch_assoc($getJobDetailsResult)) {
                                        ...
                                        if ($getFarmerDetailsResult && mysqli_num_rows($getFarmerDetailsResult) > 0) {
                                            $farmerData = mysqli_fetch_assoc($getFarmerDetailsResult);
                                            $firstName = htmlspecialchars($farmerData['firstName']);
                                            $lastName = htmlspecialchars($farmerData['lastName']);
                                        } else {
                                            $firstName = "Unknown";
                                            $lastName = "Farmer";
                                        }
                                        ...
                                        if (!isset($_SESSION['role']) || $_SESSION['role'] != "Worker") {
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="">
                                                    ...
                                                    <form>
                                                        <div class="row g-3">
                                                            <div class="col-12">
                                                                <textarea class="form-control" rows="5" placeholder="Cover Letter" name="cLetter"></textarea>
                                                            </div>
                                                            <div class="col-12">
                                                                <a href="LoginAsWorker.php"><button class="btn btn-primary w-100" type="button">Apply Now</button></a>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="bg-light rounded p-5 wow slideInUp" data-wow-delay="0.1s">
                                                    ...
                                                    <div class="col-12">
                                                        <a href="ViewFarmerProfile.php?farmerId=' . $farmerId . '" style="color: white;"><button class="btn btn-primary w-100">View Profile</button></a>
                                                    </div>
                                                </div>
                                            </div>';
                                        } else {
