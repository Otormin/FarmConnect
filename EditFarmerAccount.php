...
if(isset($_POST['submit'])){
    ...
    $updateQueue = "UPDATE farmers SET firstName = '$firstName', lastName = '$lastName', phoneNumber = '$phoneNumber', farmLocation = '$farmLocation', registrationDate = '$registrationDate', accountNumber = '$accountNumber', accountName = '$accountName', bankName = '$bankName', DOB = '$DOB', image = '$imgContent', email = '$email', password = '$password' WHERE farmerId = $farmerId";
    ...
    if ($updateQueueResult) {
        ...
        echo "Error updating farmer profile: " . $conn->error;
    }
}
