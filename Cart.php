...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <?php
            ...
            if($role == ""){
                echo '<p style="margin-top: 100px">No details available.</p>';
            }
        ?>
        ...
        <!-- Cart Start -->
            ...
            <?php
                ...
                if($role == ""){
                    echo '<a href="LoginAs.html"><button class="btn btn-primary" style="padding: 5px; width: 100px;">Login</button></a>';
                }
            ?>
        <!-- Cart End -->
